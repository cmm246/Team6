...
public class MapTest extends TestCase{
	...
	public void testSave() {
		...
		//Character ch=new Character("snake","a big snake",r1,100,0.6,5,false,false);
		...
		e1.setEnd(r2.getPos());
		//e1.addCondition(new SpecificProbality(0.8));//add probality
		//e1.addCondition(new SpecificMagicWord("Room"));//add magic word
		...
		item3.addCondition(new SpecificMagicWord("magic"));
		r1.addItem(item3);
		...
		Door2.addProp(Property.LOCKABLE, false);
		Door2.setName("Door2");
		...
		e5.setEnd(r2.getPos());
		e5.addCondition(new RoomVisited(r3));
		r3.addConnection(e5);
		...
		Character ch6=new Character("tiger","a big tiger",r5,100,0.6,10,true,true);
		ch6.setFollow(true);
		ch6.setAttackMessage("I am tiger, I can bite you more than once and i will follow you");
		Character ch7=new Character("nicetiger","a big tiger",r5,100,0.6,10,true,true);
		ch7.setAttackMessage("I am niceTiger, I can bite you more than once and i will follow you");
		ch7.setFollow(false);
		...
		java.io.File f = new java.io.File("m15.dat");
		try{
			m.save(f);
		}catch(Exception e){
